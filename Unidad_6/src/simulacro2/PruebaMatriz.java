...
public class PruebaMatriz {
	...
	public static void main(String[] args) {
		...
		double[][]mi=new double[matriz.getTamfil()][matriz.getTamcol()];
		
		matriz=new MatrizDispersa(mi, 50);
		
		double tamaño=(matriz.getTamcol())*(matriz.getTamfil());
	
		ElementoMatriz[] m=new ElementoMatriz[ (int) tamaño];
		m[0]=new ElementoMatriz(5,6,5);
		...
		MatrizDispersa.imprimeMatriz(matriz,matriz.getTamfil(),matriz.getTamcol(),matriz.getPorcentaje());
